...
const Profile = () => {
	...
	const incResult = profile?.income && calcTransaction(profile?.income ? profile.income : []);
		...
		<>
			{
				...
				<section className="py-5">
					<div className="container">
						<div className="p-8 border position-relative rounded-2">
							<div className="mb-6 d-flex align-items-center">
								...
								<div>
									...
									<button
										onClick={() =>
											navigate("update-profile", { state: { user: userAuth } }
											)
										}
										className="btn"
									>
